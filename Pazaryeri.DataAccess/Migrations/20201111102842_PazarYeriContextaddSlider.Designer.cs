...
namespace Pazaryeri.DataAccess.Migrations
{
    ...
    [Migration("20201111102842_PazarYeriContextaddSlider")]
    partial class PazarYeriContextaddSlider
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pazaryeri.Entities.Concrete.Banner", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pazaryeri.Entities.Concrete.Marka", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pazaryeri.Entities.Concrete.Secenek", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pazaryeri.Entities.Concrete.SecenekMadde", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("SecenekMadde");
                });

            modelBuilder.Entity("Pazaryeri.Entities.Concrete.Slider", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pazaryeri.Entities.Concrete.Uye", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pazaryeri.Entities.Concrete.Banner", b =>
                {
                    b.HasOne("Pazaryeri.Entities.Concrete.Kategori", "Kategori")
                        .WithOne("Banner")
                        .HasForeignKey("Pazaryeri.Entities.Concrete.Banner", "KategoriId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Pazaryeri.Entities.Concrete.SecenekMadde", b =>
                {
                    b.HasOne("Pazaryeri.Entities.Concrete.Secenek", "Secenek")
                        .WithMany("SecenekMadde")
            ...
            modelBuilder.Entity("Pazaryeri.Entities.Concrete.Uye", b =>
                {
                    b.HasOne("Pazaryeri.Entities.Concrete.AppUser", "AppUser")
                        .WithOne("Uye")
                        .HasForeignKey("Pazaryeri.Entities.Concrete.Uye", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
